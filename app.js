document.addEventListener('DOMContentLoaded', () => {
  ...
  //randomely select tetrominoe
  let random = Math.floor(Math.random()*theTetrominoes.length)
  // console.log(random);
  let current = theTetrominoes[random][currentRotation] //currentRotation
  ...
  //moke tetromino move down every second
  ...
  // move the tetrominoes left, unless at edge
  function moveLeft() {
    undraw()
